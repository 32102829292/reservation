...
<head>
    ...
    <style>
        ...
        @media(max-width:639px) { .grid-main .side-col { gap: 12px; } }
        ...
        @media(max-width:639px) { .grid-lib { grid-template-columns: 1fr !important; } }
        ...
        @media(max-width:480px) { .grid-four { gap: 10px; } }
        ...
        @media(min-width:1024px) { #tl-toast-container { bottom: 24px; } }

        @media(max-width:479px) {
            #tl-toast-container { left: 12px; right: 12px; max-width: none; }
        }
        ...
        @media(max-width:479px) {
            .avail-pill { font-size: .52rem !important; padding: 2px 5px !important; }
        }
        ...
        @media(max-width:479px) {
            .bk-row  { gap: 8px; padding: 6px; }
            .bk-date { width: 34px; height: 34px; }
            .bk-name { font-size: .78rem; }
            .bk-time { font-size: .62rem; }
        }
        ...
        @media(max-width:639px) {
            ...
            .lib-stat-item { flex: 1 1 calc(50% - 4px); min-width: 0; padding: 6px 8px; box-sizing: border-box; }
        ...
        @media(max-width:479px) {
            .lib-banner    { padding: 12px !important; word-break: break-word; }
            .lib-stat-item { flex: 1 1 calc(50% - 4px) !important; min-width: 0 !important; box-sizing: border-box !important; overflow: hidden; }
            .lib-stat-lbl  { font-size: .44rem !important; }
        ...
        .book-spine {
            ...
            align-self: stretch; flex-shrink: 0; min-height: 26px;
        }
        ...
        @media(max-width:479px) {
            .book-row   { gap: 8px; padding: 6px 4px; }
            .book-spine { min-height: 20px; }
        }

        /* ── Pending items ── */
        .pending-item {
            padding: .7rem; background: #fffbeb;
        ...
        .date-row {
            ...
            padding: .75rem; border-bottom: 1px solid #f8fafc;
        ...
        .print-modal-card {
            ...
            animation: slideUp .2s ease; box-shadow: var(--shadow-lg);
        }

        @media(max-width:479px) {
            .print-modal-back { padding: .75rem; }
            .print-modal-card { border-radius: var(--r-lg); padding: 18px 16px; }
        }
        ...
        .tl-print-toggle button {
            ...
            transition: all .15s; color: var(--text-sub); font-family: var(--font);
        }
        ...
        .tl-page-counter button {
            ...
            border: 1px solid rgba(99, 102, 241, .15);
            background: var(--card); font-weight: 800; font-size: 1rem;
            cursor: pointer; display: flex; align-items: center; justify-content: center;
            color: var(--indigo); transition: all .15s; flex-shrink: 0;
        }
        ...
        .tl-save-btn {
            width: 100%; padding: .875rem; border-radius: var(--r-sm);
            border: none; background: var(--indigo); color: white;
            font-size: .875rem; font-weight: 800; cursor: pointer;
            transition: all .2s; margin-top: 1rem; font-family: var(--font);
        ...
        .tl-skip-btn {
            width: 100%; padding: .65rem; border-radius: var(--r-sm);
            border: none; background: transparent; color: var(--text-sub);
            font-size: .8rem; font-weight: 700; cursor: pointer;
            transition: color .15s; margin-top: .3rem; font-family: var(--font);
        }
        ...
        @media(max-width:479px) {
            .notif-dd { left: 10px; right: 10px; width: auto; top: 68px; }
        }
        ...
        .borrow-pill {
            ...
            background: var(--indigo-light);
            border: 1px solid var(--indigo-border);
            color: var(--indigo); padding: 8px 14px;
...
<body>
    ...
    <script>
        ...
        /* FIX: only mark logged on HTTP 2xx success */
        ...
        /* FIX: declared at module scope so adminToggleDark patch can reference it */
        ...
        /* FIX: patch adminToggleDark immediately (before DOMContentLoaded)
           so it always wraps the real toggle function from admin_layout.php */
        ...
        /* FIX: clear interval on page unload to prevent memory leak */
