            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-[32px] border border-slate-200 shadow-sm p-8 text-center sticky top-8">
                        ...
                        <h3 class="text-xl font-black text-slate-800"><?= htmlspecialchars($user['name'] ?? 'SK Officer') ?></h3>
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <!-- Info banner -->
                    <div class="bg-green-600 rounded-[32px] p-8 text-white flex items-center gap-6">
