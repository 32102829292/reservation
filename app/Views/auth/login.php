  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .logo-ring {
      ...
      border: 1.5px solid var(--indigo-brd);
      display: flex;
      align-items: center;
      justify-content: center;
      margin-bottom: 14px;
      overflow: hidden;
      box-shadow: 0 4px 16px rgba(55,48,163,.14);
    }
    ...
    .welcome-pill {
      background: var(--indigo-light);
      border: 1px solid var(--indigo-brd);
    ...
    .welcome-pill .wp-text h3 {
      font-size: 12px;
      font-weight: 800;
      color: var(--indigo);
      letter-spacing: -.01em;
    }
    .welcome-pill .wp-text p {
      font-size: 11px;
      color: var(--muted);
      font-weight: 500;
      margin-top: 1px;
    ...
    .field-wrap:focus-within .field-icon { color: var(--indigo); }
    ...
    .btn-modal-accept.c-in:hover { background: var(--indigo-dark); box-shadow: 0 6px 18px rgba(55,48,163,.38); }
    ...
    .fp-info {
      background: var(--indigo-light); border: 1px solid var(--indigo-brd);
      border-radius: 10px; padding: 10px 13px; margin-bottom: 1.1rem;
      display: flex; align-items: flex-start; gap: 8px;
      font-size: 12px; color: var(--indigo); font-weight: 600; line-height: 1.55;
    }
    ...
    .resend-btn {
      ...
      color: var(--indigo-mid); transition: color .18s; padding: 0;
    }
    ...
    .btn-fp-next:hover { background: var(--indigo-dark); transform: translateY(-1px); box-shadow: 0 6px 18px rgba(55,48,163,.38); }
...
<body>
  ...
  <div class="login-wrapper">
    ...
    <div class="login-card">
      ...
      <div class="logo-hero">
        <div class="logo-ring">
          <img src="data:image/png;base64," alt="Brgy. F De Jesus">
        </div>
        <h1>Welcome Back!</h1>
      ...
      <?php if(session()->getFlashdata('error')): ?>
        <div class="flash flash-error"><i class="fa-solid fa-circle-exclamation"></i><span><?= session()->getFlashdata('error') ?></span></div>
      <?php endif; ?>
      <?php if(session()->getFlashdata('success')): ?>
        <div class="flash flash-success"><i class="fa-solid fa-circle-check"></i><span><?= session()->getFlashdata('success') ?></span></div>
      <?php endif; ?>
      <?php if(session()->getFlashdata('info')): ?>
        <div class="flash flash-info"><i class="fa-solid fa-circle-info"></i><span><?= session()->getFlashdata('info') ?></span></div>
      <?php endif; ?>
      ...
      <div class="modal-body">
        ...
        <div class="fp-panel active" id="fp1">
          ...
          <div style="margin-bottom:1rem">
            ...
            <div style="position:relative">
              <i class="field-icon fa-regular fa-envelope"></i>
              <input type="email" id="fpEmail" class="field-input"
        ...
        <div class="fp-panel" id="fp3">
          ...
          <div style="margin-bottom:1rem">
            ...
            <div style="position:relative">
              <i class="field-icon fa-solid fa-lock"></i>
              <input type="password" id="fpPwd" class="field-input pr"
                     placeholder="Min. 8 characters" autocomplete="new-password" oninput="fpStrength()">
          ...
          <div style="margin-bottom:1rem">
            ...
            <div style="position:relative">
              <i class="field-icon fa-solid fa-lock"></i>
              <input type="password" id="fpConf" class="field-input pr"
  ...
  <div class="overlay" id="termsOverlay">
    <div class="modal-box">
      ...
      <div class="modal-body" id="termsBody">
        ...
        <div class="ts"><div class="ts-head"><div class="ts-num in">04</div><h3>Responsible Use of Resources</h3></div><p>Users are responsible for the proper care of all reserved equipment and facilities. You agree to:</p><ul><li class="li-in">Treat all equipment with care and report any damage immediately.</li><li class="li-in">Not install unauthorized software or modify system settings.</li><li class="li-in">Use resources solely for educational and approved purposes.</li><li class="li-in">Leave the workstation clean and in its original condition after use.</li></ul></div>
        <div class="ts"><div class="ts-head"><div class="ts-num in">05</div><h3>Account Suspension &amp; Termination</h3></div><p>The administration reserves the right to suspend or terminate accounts that violate these terms, including repeated no-shows, misuse of equipment, providing false information, or disruptive behavior.</p></div>
...
const _hdrs     = () => ({'Content-Type':'application/json', [_csrfName]: _csrfHash});
...
function fpReset(){
  ...
  [1,2,3,4].forEach(j=>{
    const el=document.getElementById('ss'+j);
...
async function fpS1(){
  ...
  try{
    ...
    if(d.success){
      ...
      document.getElementById('fpEmailMsg').textContent=d.message||'Something went wrong.';
      fpErr('fpEmailErr',true);
    }
  }catch{
...
async function fpS2(){
  ...
  if(otp.length<6){
    fpOtpErr('Please enter the complete 6-digit code.');
    return;
  }
  ...
  try{
    ...
    if(d.success){
      ...
      fpOtpErr(d.message||'Invalid or expired code.');
    }
  }catch{
    fpOtpErr('Network error. Please try again.');
  }finally{
    fpLoad(false);
  }
}
...
function fpLoad(on,lbl){
  ...
  if(on){
    document.getElementById('fpNextLbl').innerHTML='<div class="spin"></div> '+lbl;
  }else{
    fpShowStep(fpStep);
  }
}
  ...
  for(let i=0;i<6;i++){
    ...
    el.addEventListener('input',function(){
      ...
      if(v){
        ...
        if(i<5) document.getElementById('o'+(i+1))?.focus();
        if(i===5) setTimeout(fpNext,200);
    ...
    el.addEventListener('paste',function(e){
      ...
      p.split('').slice(0,6).forEach((c,j)=>{
        const t=document.getElementById('o'+j);
        if(t){t.value=c;t.classList.add('filled');}
      });
