...
<head>
    ...
    <style>
        ...
        .sidebar-header {
            flex-shrink: 0;
            padding: 16px;                      /* matches dashboard */
            border-bottom: 1px solid #e2e8f0;   /* matches dashboard */
        }
        ...
        .sidebar-footer {
            flex-shrink: 0;
            padding: 16px;                      /* matches dashboard */
            border-top: 1px solid #e2e8f0;      /* matches dashboard */
        }
        ...
        .type-btn.active { background: #2563eb; color: white; box-shadow: 0 4px 12px rgba(37,99,235,0.25); }
        ...
        .btn-primary:hover { background: #1d4ed8; transform: translateY(-2px); box-shadow: 0 12px 20px -5px rgba(37,99,235,0.35); }
        ...
        .pc-section { background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 20px; padding: 1.5rem; }
    </style>
</head>
<body class="flex">
