...
<head>
    ...
    <style>
        ...
        /* ── Tooltip — flips above, capped so it never clips ── */
        ...
        /* On narrow screens push tooltip to the right so it doesn't clip left edge */
        ...
        /* ── Mobile log card (shown < md, hidden table) ── */
        .log-card {
        ...
        /* ── Footer legend wraps gracefully ── */
...
<body class="flex min-h-screen">
    ...
    // Badge / sentence helpers used by both table and cards
    ...
    <main class="flex-1 min-w-0 p-4 sm:p-6 lg:p-12 pb-32">
        ...
        <!-- Stat cards — 2 cols → 3 cols (sm) → 5 cols (lg) -->
        ...
        <!-- Footer legend — wraps on small screens -->
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Collect both table rows and mobile cards
        ...
        function filterAll() {
            ...
            // Filter mobile cards (same logic)
        ...
        filterAll(); // initialise count on load
    });
    </script>
</body>
</html>