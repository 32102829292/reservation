            ...
            <table>
                ...
                <tbody id="skTableBody">
                    <?php if (empty($allMerged)): ?>
                        <tr><td colspan="6"><div style="padding:80px 24px;text-align:center">
                    ...
                    <?php else: ?>
                        ...
                        ?>
                            <tr class="sk-row" data-status="<?=$s?>" data-search="<?=strtolower("$name $email")?>">
                                ...
                                <td><p style="font-size:13px;color:var(--text-muted);font-weight:600;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:180px"><?=$email?></p></td>
                                <td><p style="font-size:13px;color:var(--text-muted);font-weight:600;white-space:nowrap"><?=$date?></p></td>
