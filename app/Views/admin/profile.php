...
<head>
    ...
    <style>
        ...
        .profile-avatar {
            width: 80px;
            height: 80px;
            background: linear-gradient(135deg, #1d4ed8 0%, var(--indigo) 50%, #818cf8 100%);
            border-radius: 22px;
            display: flex;
            align-items: center;
            ...
            font-weight: 800;
            color: white;
            box-shadow: 0 8px 28px rgba(55, 48, 163, .35)
        }
        ...
        /* ── Tip banner ── */
        .tip-banner {
            background: linear-gradient(135deg, var(--indigo) 0%, var(--indigo-mid) 60%, #6366f1 100%);
        ...
        body.dark .modal-card [style*="background:#f8fafc"] {
            background: #101e35 !important
        }

        body.dark .modal-card [style*="background:#fef2f2"] {
...
<body>
            ...
            <form action="<?= base_url('admin/profile/update') ?>" method="POST" style="display:flex;flex-direction:column;gap:14px">
                ...
                <div>
                    ...
                    <div class="pw-strength">
                        <div id="pwFill" class="pw-fill" style="width:0%"></div>
                    </div>
            ...
            <div class="profile-grid">
                ...
                <div style="display:flex;flex-direction:column;gap:14px">
                    ...
                    <div class="card card-p" style="text-align:center">
                        ...
                        <button class="action-btn" style="width:100%;margin-top:14px;justify-content:center" onclick="openModal('editModal')">
                ...
                <div style="display:flex;flex-direction:column;gap:14px">
                    ...
                    <div class="card card-p">
                        ...
                        <div class="danger-row">
                            <div style="min-width:0">
                                <p style="font-size:.83rem;font-weight:700;color:#0f172a">Password</p>
                                <p style="font-size:.7rem;color:#94a3b8;margin-top:2px">Update regularly to protect admin access</p>
                            </div>
                            <button onclick="openModal('editModal')" class="btn-sm">Change</button>
                        </div>
                        <div class="danger-row">
                            <div style="min-width:0">
                                <p style="font-size:.83rem;font-weight:700;color:#0f172a">Account Access</p>
                                <p style="font-size:.7rem;color:#94a3b8;margin-top:2px">Signed in with full administrator privileges</p>
                            </div>
    ...
    <script>
        ...
        function openModal(id) {
            ...
            if (id === 'deleteModal') {
                const inp = document.getElementById('deleteConfirmInput'),
                    hint = document.getElementById('deleteInputHint');
                inp.value = '';
        ...
        function checkPw(val) {
            ...
            if (!val) {
                fill.style.width = '0%';
                fill.style.background = 'rgba(99,102,241,.1)';
        ...
        function checkDeleteInput(val) {
            const btn = document.getElementById('deleteConfirmBtn'),
                hint = document.getElementById('deleteInputHint'),
                inp = document.getElementById('deleteConfirmInput');
            if (val === 'DELETE') {
                btn.disabled = false;
                btn.style.opacity = '1';
