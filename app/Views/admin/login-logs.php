...
<head>
    ...
    <style>
        ...
        .filter-inline .search-wrap {
            flex: 1;
            min-width: 0;
            position: relative;
        }

        .filter-inline .search-wrap .search-input {
            width: 100%;
            padding-right: 30px;
        }

        .filter-inline .date-wrap {
            position: relative;
            flex-shrink: 0;
            width: 152px;
        }

        .filter-inline .date-wrap .date-input {
            width: 100%;
            padding-left: 34px;
            padding-right: 30px;
        }
        ...
        @media(max-width:480px) {
            .filter-inline .date-wrap { width: 130px; }
        }

        /* ── Filter tabs — prevent text clipping ── */
        .qtab {
            white-space: nowrap;
            flex-shrink: 0;
        }
        ...
        /* ── PATCH: STAT GRID — 3-column responsive ── */
        ...
        /* ── Date input base styles (kept from original) ── */
        .date-input {
        ...
        <div class="card fade-up-1" style="padding:16px 20px;margin-bottom:16px;">
            ...
            <div class="filter-inline">
                ...
                <div class="search-wrap">
                    ...
                    <input type="text" id="searchInput" class="search-input" placeholder="Search by name, email, or role…" oninput="applyFilters();toggleClear('searchInput','searchClear')">
                ...
                <div class="date-wrap">
                    ...
                    <input type="date" id="dateInput" class="date-input" onchange="applyFilters();toggleClear('dateInput','dateClear')">
