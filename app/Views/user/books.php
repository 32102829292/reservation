            ...
            <div class="detail-body">
                ...
                <div class="flex items-start justify-between gap-3 mb-4">
                    ...
                    <div class="flex flex-col items-end gap-2 flex-shrink-0">
                        <button onclick="closeDetailModal()" class="w-9 h-9 rounded-2xl bg-slate-100 hover:bg-slate-200 text-slate-500 flex items-center justify-center transition"><i class="fa-solid fa-xmark"></i></button>
    ...
    <div class="modal-backdrop" id="borrowModal" onclick="onBorrowBackdrop(event)">
        <div class="modal-card">
            ...
            <div class="flex justify-between items-center mb-5">
                ...
                <button onclick="closeBorrowModal()" class="w-9 h-9 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-500 flex items-center justify-center transition"><i class="fa-solid fa-xmark"></i></button>
            </div>
            <div class="flex items-center gap-4 p-4 bg-green-50 rounded-2xl border border-green-100 mb-5">
                <div class="w-10 h-10 bg-green-100 rounded-xl flex items-center justify-center flex-shrink-0"><i class="fa-solid fa-book-open text-green-600"></i></div>
                <div>
            ...
            <div class="flex gap-3">
                ...
                <form id="borrowForm" method="post" action="" class="flex-1">
                    <?= csrf_field() ?>
                    <button type="submit" class="w-full py-3 bg-green-600 hover:bg-green-700 text-white rounded-2xl font-bold text-sm transition shadow-sm shadow-green-200">Yes, Borrow</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <main class="flex-1 min-w-0 p-4 lg:p-10 pb-32">
        ...
        <header class="flex items-start justify-between mb-8 gap-4 fade-in-up">
            <div>
                ...
                <h2 class="text-2xl lg:text-3xl font-black text-slate-900 tracking-tight leading-tight">Community <span class="text-green-600">Library</span></h2>
        ...
        <?php if (session()->getFlashdata('error')): ?>
            <div class="mb-6 px-5 py-4 bg-red-50 border border-red-200 text-red-700 font-bold rounded-2xl flex items-center gap-3 text-sm">
                <i class="fa-solid fa-circle-exclamation text-red-400"></i><?= session()->getFlashdata('error') ?>
            </div>
        <?php endif; ?>
        ...
        <div class="dash-card p-5 mb-6">
            ...
            <div id="ragRes" class="hidden mt-4">
                <div class="p-4 bg-green-50 border border-green-100 rounded-2xl mb-3">
                    <p class="text-[10px] font-black uppercase tracking-widest text-green-600 mb-1.5 flex items-center gap-1"><i class="fa-solid fa-star text-[9px]"></i> Librarian Suggestion</p>
                        ...
                        <div class="book-card"
                            ...
                            <div class="book-cover">
                                ...
                                <?php if (!empty($book['genre'])): ?>
                                    <span class="cover-genre-badge px-2 py-0.5 bg-white/90 backdrop-blur text-green-700 text-[10px] font-black uppercase tracking-wider rounded-full border border-green-100"><?= esc($book['genre']) ?></span>
                                <?php endif; ?>
        ...
        async function doRag() {
            ...
            try {
                ...
                (d.books || []).forEach(b => {
                    ...
                    chip.className = 'px-3 py-1.5 rounded-xl border font-bold text-xs transition ' + (avail ? 'bg-green-50 border-green-200 text-green-700 hover:bg-green-100' : 'bg-slate-50 border-slate-200 text-slate-400 border-dashed');
