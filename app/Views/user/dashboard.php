    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sidebar-item.active {
            ...
            color: white;
            box-shadow: 0 10px 20px -5px rgba(22,163,74,0.35);
        }
        ...
        .stat-card::after {
            ...
            width:80px; height:80px; border-radius:50%; opacity:0.06; transition:all 0.3s;
        }
        ...
        .fc-button-primary {
            ...
            font-weight: 700 !important; font-size: 0.75rem !important; padding: 0.3rem 0.65rem !important;
        }
        ...
        .fc-daygrid-event {
            border-radius:6px !important; font-size:0.68rem !important; font-weight:700 !important;
        ...
        .notif-badge {
            ...
            font-size:0.58rem; font-weight:800; padding:0.15rem 0.35rem; border-radius:999px;
            min-width:1.1rem; text-align:center; border:2px solid white; line-height:1.2;
        }
        .notif-dropdown {
            ...
            z-index:200; display:none; overflow:hidden; animation:dropIn 0.18s ease;
        }
        ...
        .modal-backdrop {
            ...
            backdrop-filter:blur(6px); z-index:300; padding:1.25rem;
        ...
        .modal-card {
            ...
            padding:2rem; max-height:calc(100vh - 2.5rem); overflow-y:auto; margin:auto;
        ...
        /* ── Booking list ── */
        .booking-item {
            display:flex; align-items:center; gap:12px; padding:0.875rem 1rem;
            border-radius:16px; transition:all 0.2s; text-decoration:none; color:inherit;
        }
        ...
        .quick-action {
            display:flex; align-items:center; gap:12px; padding:0.875rem 1rem;
            border-radius:16px; border:1.5px solid #e2e8f0; background:white;
        ...
        .upcoming-pill {
            ...
            border-radius:20px; padding:1rem 1.25rem; display:flex; align-items:center; gap:12px;
        }
        ...
        /* ══ BOOKS SECTION ══ */
        .books-banner {
            background:linear-gradient(135deg,#1e3a2f 0%,#14532d 50%,#166534 100%);
            border-radius:28px; padding:1.75rem; position:relative; overflow:hidden; border:1px solid #15803d;
        }
        .books-banner::before {
            content:'📚'; position:absolute; right:-10px; top:-10px; font-size:7rem;
        ...
        .books-banner::after {
            ...
            background:radial-gradient(circle,rgba(255,255,255,0.05),transparent); border-radius:50%; pointer-events:none;
        }
        .book-spine-card {
            background:white; border-radius:20px; border:1px solid #e2e8f0;
            padding:1rem 1.1rem; display:flex; align-items:center; gap:12px;
            transition:all 0.22s; text-decoration:none; color:inherit; position:relative; overflow:hidden;
        }
        ...
        .rag-search-input {
            width:100%; padding:0.7rem 1rem 0.7rem 2.5rem; border-radius:16px;
        ...
        .ai-suggestion-box {
            ...
            border-radius:16px; padding:0.875rem 1rem; margin-top:0.75rem; display:none; animation:fadeIn 0.3s ease;
        }
        .ai-suggestion-box.show { display:block; }
        .shimmer {
            height:11px; border-radius:6px;
            background:linear-gradient(90deg,#e2e8f0 25%,#f1f5f9 50%,#e2e8f0 75%);
            background-size:200% 100%; animation:shimmerAnim 1.4s infinite; margin-bottom:0.45rem;
        }
        ...
        /* ══ TIMER BANNER ══ */
        .timer-banner {
            display:none; border-radius:20px; padding:0.875rem 1.25rem;
            margin-bottom:1.25rem; animation:slideDown 0.35s cubic-bezier(0.34,1.56,0.64,1) both;
        ...
        /* Progress bar inside timer banner */
        .timer-progress-wrap {
            height: 5px;
            border-radius: 999px;
        ...
        .timer-digit {
            ...
            background:rgba(0,0,0,0.08); border-radius:10px; padding:0.25rem 0.5rem;
        ...
        .login-toast {
            ...
            padding:0.875rem 1.25rem; z-index:500;
            max-width:420px; width:calc(100% - 2.5rem);
            box-shadow:0 24px 48px -8px rgba(0,0,0,0.35);
        ...
        .toast-close {
            ...
            border-radius:8px; background:rgba(255,255,255,0.1); border:none;
            color:white; cursor:pointer; display:flex; align-items:center;
            justify-content:center; font-size:0.7rem; transition:background 0.15s;
        }
...
<body class="flex">
    ...
    <main class="flex-1 min-w-0 p-4 lg:p-10 pb-32">
        ...
        <div id="timerBanner" class="timer-banner">
            ...
            <!-- Progress bar showing time elapsed through the reservation -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                    ...
                    <div class="hidden sm:flex items-center gap-3 flex-wrap justify-end">
                        <?php foreach ([['#fbbf24','Pending'],['#10b981','Approved'],['#f87171','Declined'],['#a855f7','Claimed']] as [$c,$l]): ?>
                            <span class="flex items-center gap-1 text-[10px] font-bold text-slate-500">
                                <span class="w-2 h-2 rounded-full flex-shrink-0" style="background:<?= $c ?>"></span><?= $l ?>
                            </span>
                        <?php endforeach; ?>
                    </div>
                </div>
            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="dash-card p-5">
                    ...
                    <div class="space-y-2">
                        <a href="<?= base_url('/reservation') ?>" class="quick-action">
                            ...
                            <i class="fa-solid fa-chevron-right text-xs text-slate-300 ml-auto"></i>
                        </a>
                        <a href="<?= base_url('/reservation-list') ?>" class="quick-action">
                        ...
                        <a href="<?= base_url('/books') ?>" class="quick-action">
                        ...
                        <a href="<?= base_url('/profile') ?>" class="quick-action">
                            <div class="w-8 h-8 bg-purple-50 rounded-xl flex items-center justify-center flex-shrink-0">
                                <i class="fa-regular fa-user text-purple-500 text-xs"></i>
                            </div>
                ...
                <div class="dash-card p-5 flex-1">
                    ...
                    <?php else: ?>
                        <div class="text-center py-8">
                            ...
                            <a href="<?= base_url('/reservation') ?>" class="inline-flex items-center gap-1 mt-3 text-xs font-bold text-green-600 hover:text-green-700">
                                <i class="fa-solid fa-plus text-[10px]"></i> Make your first reservation
                            </a>
                        </div>
                    <?php endif; ?>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 flex flex-col gap-5">
                    ...
                    <div class="relative z-10 flex gap-4 mt-4 pt-4 border-t border-white/10">
                        <div class="flex items-center gap-2">
                            <div class="w-7 h-7 bg-white/10 rounded-xl flex items-center justify-center">
                                <i class="fa-solid fa-bookmark text-green-300 text-xs"></i>
                            </div>
                            <div>
                                <p class="text-[10px] font-black text-green-300 uppercase tracking-wider">My Borrows</p>
                                <p class="text-sm font-black text-white"><?= count($myBorrowings) ?></p>
                            </div>
                        </div>
                        <div class="flex items-center gap-2">
                            <div class="w-7 h-7 bg-white/10 rounded-xl flex items-center justify-center">
                                <i class="fa-solid fa-hourglass-half text-amber-300 text-xs"></i>
                            </div>
                            <div>
                                <p class="text-[10px] font-black text-green-300 uppercase tracking-wider">Pending</p>
                                <p class="text-sm font-black text-white"><?= count(array_filter($myBorrowings, fn($b) => ($b['status'] ?? '') === 'pending')) ?></p>
                            </div>
                        </div>
                        <div class="flex items-center gap-2">
                            <div class="w-7 h-7 bg-white/10 rounded-xl flex items-center justify-center">
                            ...
                            <div>
                                <p class="text-[10px] font-black text-green-300 uppercase tracking-wider">Active</p>
                                <p class="text-sm font-black text-white"><?= count(array_filter($myBorrowings, fn($b) => ($b['status'] ?? '') === 'approved')) ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="dash-card p-5">
                    <div class="flex items-center gap-3 mb-3">
                        <div class="w-8 h-8 bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl flex items-center justify-center">
                            <i class="fa-solid fa-wand-magic-sparkles text-green-600 text-xs"></i>
                        </div>
                        <div>
                            <h3 class="font-extrabold text-slate-800 text-sm leading-tight">AI Book Finder</h3>
                            <p class="text-[10px] text-slate-400 font-medium">Describe what you want to read</p>
                        </div>
                    </div>
                    <div class="rag-search-wrap">
                        <i class="fa-solid fa-magnifying-glass rag-search-icon"></i>
                        <input type="text" id="dashRagInput" class="rag-search-input"
                               placeholder="e.g. Filipino history, funny stories, adventure for kids…"
                               onkeydown="if(event.key==='Enter') dashRagSearch()">
                    </div>
                    ...
                    <div class="ai-suggestion-box" id="dashRagResult">
                        <div class="flex items-start gap-2 mb-2">
                            <i class="fa-solid fa-robot text-green-600 text-xs mt-0.5 flex-shrink-0"></i>
                            <p class="text-[10px] font-black text-green-700 uppercase tracking-wider">Librarian Suggestion</p>
                        </div>
                    ...
                    <div class="flex items-center justify-between mt-3">
                        <button onclick="dashRagSearch()" id="dashRagBtn"
                                class="flex items-center gap-1.5 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-xl font-bold text-xs transition">
                            <i class="fa-solid fa-wand-magic-sparkles text-[10px]"></i> Find Books
                        </button>
            ...
            <!-- Right: Featured Books + My Borrows -->
            <div class="flex flex-col gap-5">
                ...
                <div class="dash-card p-5">
                    ...
                    <?php else: ?>
                        <div class="text-center py-6">
                            <i class="fa-solid fa-book text-3xl text-slate-200 mb-2 block"></i>
                            <p class="text-xs text-slate-400 font-medium">No books yet</p>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="dash-card p-5">
                    ...
                    <?php if (!empty($activeBorrows)): ?>
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center gap-3 p-2.5 rounded-2xl bg-slate-50 border border-slate-100">
                                <div class="w-8 h-8 bg-white rounded-xl flex items-center justify-center flex-shrink-0 border border-slate-200 font-black text-sm text-green-700">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <?php if (!empty($borrow['due_date']) && $bs === 'approved'): ?>
                                        <p class="text-[10px] text-slate-400 font-medium">Due <?= date('M j', strtotime($borrow['due_date'])) ?></p>
                                    <?php endif; ?>
                                </div>
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            ...
                            <a href="<?= base_url('/books') ?>" class="inline-flex items-center gap-1 mt-2 text-[10px] font-bold text-green-600 hover:text-green-700">
                                <i class="fa-solid fa-book-open text-[9px]"></i> Borrow a book
                            </a>
                        </div>
                    <?php endif; ?>
                </div>
    ...
    <script>
        ...
        function markAllAsRead() {
            ...
            notifications.forEach(n=>n.read=true); updateBadge(); renderNotifs();
        }
        function markAsRead(id) {
            const ids=getNotifiedIds(); if(!ids.includes(id)) saveNotifiedIds([...ids,id]);
            const n=notifications.find(n=>n.id===id); if(n){n.read=true;updateBadge();renderNotifs();}
        }
        ...
        function renderNotifs() {
            ...
            if(!notifications.length){
                list.innerHTML=`<div class="text-center py-8 px-4"><i class="fa-regular fa-bell-slash text-3xl text-slate-200 mb-2 block"></i><p class="text-sm text-slate-400 font-medium">All caught up!</p></div>`;
                return;
            }
            ...
            const cal = new FullCalendar.Calendar(document.getElementById('calendar'), {
                ...
                dayCellDidMount: info => {
                    ...
                    if(res?.length) {
                        ...
                        badge.style.cssText = 'font-size:9px;font-weight:800;color:white;background:#16a34a;border-radius:999px;width:16px;height:16px;display:flex;align-items:center;justify-content:center;margin-left:auto;margin-right:4px;margin-bottom:2px;';
        ...
        // ══ COUNTDOWN BANNER WITH PROGRESS BAR ════════════════════════════════
        function initCountdownBanner() {
            ...
            const hEl          = document.getElementById('tdHv');
            const mEl          = document.getElementById('tdMv');
            const sEl          = document.getElementById('tdSv');
            ...
            function tick() {
                ...
                if(mode==='active') {
                    if(minsLeft<=10)       { banner.classList.add('urgent');  iconEl.innerHTML='<i class="fa-solid fa-triangle-exclamation"></i>'; }
                    else if(minsLeft<=20)  { banner.classList.add('warning'); iconEl.innerHTML='<i class="fa-solid fa-hourglass-half"></i>'; }
                    else                   { banner.classList.add('safe');    iconEl.innerHTML='<i class="fa-solid fa-hourglass-start"></i>'; }
                    ...
                    // Progress bar = how far through the reservation we are
        ...
        function showLoginToast() {
            ...
            _approved.forEach(r => {
                ...
                if(now>=start && now<end && !toastData)
                    toastData = {
                        icon:'<i class="fa-solid fa-circle-play" style="color:#22c55e"></i>',
                        bg:'#16a34a', title:'Active reservation now!',
                        body:`${r.resource_name||'Resource'} ends at ${r.end_time?.substring(0,5)} — don't forget!`
                    };
                if(!toastData && resDay===today && minsToStart>0 && minsToStart<=120)
                    toastData = {
                        icon:'<i class="fa-solid fa-bell" style="color:#f59e0b"></i>',
                        bg:'#d97706', title:`Reservation in ${Math.round(minsToStart)} min`,
                ...
                if(!toastData && resDay===today) {
                    ...
                    toastData = {
                        icon:'<i class="fa-solid fa-calendar-check" style="color:#60a5fa"></i>',
        ...
        async function dashRagSearch() {
            ...
            const res =document.getElementById('dashRagResult');
            const err =document.getElementById('dashRagErr');
            const btn =document.getElementById('dashRagBtn');
            res.classList.remove('show'); err.style.display='none';
            ...
            try {
                ...
                (d.books||[]).slice(0,4).forEach(b=>{
                    ...
                    chip.href='/books';
                    chip.className='inline-flex items-center gap-1 px-2.5 py-1 rounded-xl text-[10px] font-bold border transition '+(avail?'bg-white border-green-200 text-green-700 hover:bg-green-50':'bg-slate-50 border-slate-200 text-slate-400');
                    chip.innerHTML=`<i class="fa-solid fa-book text-[9px]"></i>${b.title}${avail?'':' <span class="text-[9px]">(out)</span>'}`;
