...
$routes->group('sk', ['filter' => 'role:sk'], function($routes) {
    ...
    $routes->get('check-guest-limit', 'SkController::checkGuestLimit');
...
$routes->group('admin', ['filter' => 'role:chairman'], function($routes) {
    ...
    $routes->post('admin/approve-resident', 'AdminController::approveResident');
    $routes->post('admin/reject-resident',  'AdminController::rejectResident');
